...
class Indicator(
    ...
    DOMAIN_CHOICES = [(0, "DCIS"), (1, "DCRFPN"), (2, "DGPN"), (3, "DCIS"), (4, "DRCPN"),
                      (5, "Équipement et Logistique"), (6, "Finances"), (7, "Ressources humaines"), (8, "SG/DRH")]
    domain = models.CharField(
        choices=DOMAIN_CHOICES,
        max_length=1
    )

    SECTOR_CHOICES = [(0, "Accueil"), (1, "Administration"), (2, "Analyses et études"), (3, "Armement"), (4, "Budget"),
    ...
    INDICATOR_TYPE_CHOICES = [(0, "Autre"), (1, "BOP"), (2, "Pilotage"), (3, "DGPN"), (4, "CG"), (5, "PAP"), (6, "UO")]
